...
Route::get('/equipos', [MenuController::class, 'equipos'])->name('equipos');
Route::get('/nosotros', [MenuController::class, 'nosotros'])->name('nosotros');
...
Route::get('/aliados', [MenuController::class, 'aliados'])->name('aliados');
Route::get('/equipo', [MenuController::class, 'equipo'])->name('equipo');
Route::get('/menu', [MenuController::class, 'menu'])->name('menu');
Route::get('/submenu', [MenuController::class, 'submenu'])->name('submenu');
Route::get('/blogs', [MenuController::class, 'blogs'])->name('blogs');

Route::get('/blog/docublog-1', [MenuController::class, 'blog'])->name('blog');
Route::get('/blog/docublog-1/{id}', [MenuController::class, 'blogview'])->name('blogview');
Route::get('/submenu/{id}', [MenuController::class, 'submenuview'])->name('submenuview');
Route::get('/mapa', [MenuController::class, 'mapa'])->name('mapa');
