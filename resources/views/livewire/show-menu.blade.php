    ...
    <x-contenedor>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="url" label="Url" name="url" id="url" type="text" value=""
                    placeholder="Url" maxlength="400" />
        ...
        <x-modal-crud x-cloak x-show="editar">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    placeholder="Url" maxlength="400" value="" />
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="url" label="Url" name="url" id="url" type="text" disabled
                    placeholder="Url" maxlength="0" value="" />
