<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-4">
        @foreach ($creditos as $credito)
            <div class="relative">
                <img class="rounded-xl mb-4 shadow-lg object-cover w-full h-60"  data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500" src="{{ asset($credito->imagen) }}">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" class="bg-white shadow-lg py-2 px-4 mt-2 rounded-lg mb-1 text-gray-700">
