    ...
    <x-contenedor>
                ...
                <x-table>
                    ...
                    <x-slot name="bodytable">
                        ...
                        <x-tr x-data="{ openOption: false }">
                            ...
                            <x-td wire:click="ver('{{ $item->id }}')">{{ $item->cargo ?? '' }}</x-td>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-input-with-label wire="nombre" label="Nombre" name="nombre" id="nombre" type="text"
                value="" placeholder="Nombre" maxlength="200" />

            <x-input-with-label wire="cargo" label="Cargo" name="cargo" id="cargo" type="text"
                value="" placeholder="Cargo" maxlength="200" />
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="nombre" label="Nombre" name="nombre" id="nombre" type="text"
                     disabled value="" placeholder="Nombre" maxlength="40" />

                    <x-input-with-label wire="cargo" label="Cargo" name="cargo" id="cargo" type="text"
                     disabled value="" placeholder="Cargo" maxlength="40" />
