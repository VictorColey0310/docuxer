                        ...
                        <div class=" transform text-center text-gray-500 my-10">
                            ...
                            <a href="{{ route('convenio') }}" >
                                <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500"
                                    class="btn text-lg rounded-full mx-auto w-56 px-5 text-white py-3 my-10 bg-[#3DC1B7] shadow-2xl hover:opacity-90 hover:shadow-lg transition-all duration-300 font-semibold">
                                    Consultalo aquí
                                </div>
                    ...
                    <div class="transform text-center text-white my-10">
                        <a href="{{route('como-asociarse')}}" >
                            <div data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500"
                                class="btn text-lg rounded-full mx-auto w-56 px-5 py-3 my-10 bg-[#3DC1B7] shadow-2xl hover:opacity-90 hover:shadow-lg transition-all duration-300 font-semibold">
                                ¿Como asociarse?
                            </div>
                        </a>
                    </div>
