                    ...
                    <x-slot name="bodytable">
                        @foreach ($consulta as $item)
                            <x-tr x-data="{ openOption: false }">
                                ...
                                <x-td
                                    wire:click="ver('{{ $item->id }}')">{{ $item->submenu->nombre ?? '' }}</x-td>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="nombre" label="nombre" name="nombre" id="nombre" type="text"
                    ...
                    <x-input-with-label wire="descripcion" label="Descripcion" name="descripcion" id="descripcion" type="text"
                    value="" placeholder="Descripcion" maxlength="4000" />
                ...
                <x-input-file wire="imagen" label="imagen" name="imagen" id="imagen" type="file" placeholder="imagen" maxlength="200" value="" />
                    ...
                    <x-select wire="submenu_id" label="Submenu" name="submenu_id" id="submenu_id" value="">
                        <x-slot name="option">
                            <option>Seleccionar</option>
                            @foreach ($consulta_submenu as $item)
        ...
        <x-modal-crud x-cloak x-show="editar">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="descripcion" label="Descripcion" name="descripcion" id="descripcion" type="text" placeholder="Descripcion" maxlength="4000" value=""/>

                    <x-input-with-label wire="url" label="url" name="url" id="url"
                    type="text" placeholder="Url" maxlength="100" value="" />
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="url" label="url" name="url" id="url"
                    disabled type="text" placeholder="Url" maxlength="0" value="" />
                    ...
                    <label for="icono" class="block text-gray-700 text-sm font-semibold mb-2">Icono</label>
                       ...
                       <x-input-with-label wire="submenu_id" label="Submenu" name="submenu_id" id="submenu_id" type="text"
                       disabled placeholder="Submenu" maxlength="0" value="" />
