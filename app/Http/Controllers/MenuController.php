...
class MenuController extends Controller
{
    ...
    {
        return view('menu.aliados');
    }

    public function equipo()
    {
        return view('menu.equipo');
    }
    ...
    {
        return view('menu.blogs');
    }

    public function blogview($id)
    {
        return view('menu/blogview', [
            'id' => $id,
        ]);
    }
    public function submenuview($id)
    {
        return view('menu/submenuview', [
            'id' => $id,
        ]);
    }
